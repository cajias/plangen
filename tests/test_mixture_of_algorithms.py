...
class TestMixtureOfAlgorithms:
    ...
    def test_select_algorithm_method(self):
        ...
        with patch('plangen.algorithms.mixture_of_algorithms.MixtureOfAlgorithms.__init__', return_value=None):
            ...
            algorithm.template_loader.get_algorithm_template.return_value = "mock_template_path"
            algorithm.template_loader.render_template.return_value = "Rendered prompt"
            
            # Mock the LLM response to include "Tree of Thought"
            mock_llm.generate.return_value = "I recommend using Tree of Thought for this problem"
            
            # Call the method
            with patch.object(algorithm, '_select_algorithm', wraps=lambda x, y: "Tree of Thought"):
