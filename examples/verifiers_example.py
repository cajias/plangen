...
def custom_verifier_example():
    ...
    def verify_recipe(problem: str, constraints: List[str], plan: str) -> Tuple[str, float]:
    ...
    problem = "Create a vegetarian pasta recipe that can be prepared in under 30 minutes."
