...
def main():
    ...
    try:
        ...
        if "selected_solution" in result and isinstance(result["selected_solution"], dict):
            print("\n=== Selected Solution ===")
            print(result["selected_solution"].get("selected_solution", "No solution details found"))
            
            print("\n=== Selection Reasoning ===")
            print(result["selected_solution"].get("selection_reasoning", "No selection reasoning found"))
