...
class CalendarVerifier(BaseVerifier):
    ...
    def __init__(self):
        ...
        self.domain_keywords = [
            ...
            "time slot", "availability", "busy", "free time"
        ]
    ...
    def extract_domain_constraints(
        ...
        availability_constraints = self._extract_availability_constraints(problem_statement)
    ...
    def _extract_time_constraints(self, problem_statement: str) -> List[str]:
        ...
        for pattern in duration_patterns:
            ...
            if match:
                ...
                constraints.append(f"The meeting duration must be exactly {duration} minutes.")
                break
        ...
        if match:
            start, end = match.groups()
            constraints.append(f"The meeting must be scheduled between {start} and {end}.")
