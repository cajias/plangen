...
class TimeSlotVerifier:
    ...
    def is_valid_meeting_slot(self, meeting_slot: str, duration_minutes: int = 30) -> Tuple[bool, str]:
        ...
        if not (self.business_hours.start <= slot.start and slot.end <= self.business_hours.end):
