...
def extract_text_from_pdf(pdf_path, start_page=0, end_page=None):
    ...
    try:
        with open(pdf_path, 'rb') as file:
            ...
            print(f"PDF has {num_pages} pages. Showing pages {start_page+1} to {end_page+1}.\n")
            print("=" * 80)
...
def main():
    ...
    parser.add_argument("--start", type=int, default=0, help="First page to extract (1-indexed)")
